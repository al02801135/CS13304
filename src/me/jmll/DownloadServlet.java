		...
		if (fileName != null) {
			...
			try {
				...
				if (fileDownload.exists()) {
					...
					try (FileInputStream fileInputStream =  // escribe tu código aquí;
							OutputStream outputStream =  // escribe tu código aquí) {

						// f. Obtener MimeType del Archivo
						String mimeType =  // escribe tu código aquí
						if (mimeType == null)
							mimeType =  // escribe tu código aquí
